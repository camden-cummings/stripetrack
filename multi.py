...
class GUIPoolRun(PoolRun):
  ...
  #  @profile
    def gui_pool(self, img_queue, done, start_recording):
        ...
        correlate1d_x_r(rearr, weights, uyy_tmp)  # , curr_scipy)
        correlate1d_y_r(uyy_tmp, weights, uyy)  # , curr_scipy)
...
#            try:
            ...
            if r.mode_noblur_img is None:
                ...
                if gui.contours_updated or r.mode_updated:
                    ...
                    correlate1d_x_r(rearr, weights, uy_tmp)  # , curr_scipy)
