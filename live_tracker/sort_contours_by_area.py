...
def sort_contours_by_area(contours, last_confident_centroid, frame_count, time, diff, mask, shape_of_rows, cell_contours, cell_centers, min_area):
    ...
    for c in contours:
        ...
        if min_area < cv2.contourArea(c) < 500000:
